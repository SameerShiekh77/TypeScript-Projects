...
var original_pin = 54321;
var balance = 10000;
const askPin = () => {
    userInput.question('Enter your pin: ', (pin) => {
        if (pin == original_pin) {
    ...
    userInput.question("\n=========================================================\nWhat you want\n1. Press 1 for Balance Inquiry\n2. Press 2 for With draw\n3. Press 3 for Deposit Money.\n4. Press 4 to quit this menu \n=========================================================\n", (input) => {
        switch (input) {
            case '1':
                ...
                break;
            case '2':
                userInput.question('Enter the amount you want to withdraw: ', (amount) => {
                    if (amount <= balance) {
                        balance -= amount;
                ...
                break;
            case '3':
                userInput.question('Enter the amount you want to deposit: ', (amount) => {
